"""
generate the log for the website
inspired by the logo of matplotlib

copyright (c) Zeyuan Hu - zhu45@wisc.edu
"""
...
# customize the configuration of matplotlib to meet our needs
...
def add_matplotlib_text(ax):
    ax.text(0.95, 0.5, 'Welcome to Zeyuan\'s World!', color='#11557c', fontsize=50,
